...
@Entity(name = ThreePointFieldGoal.ENTITY_NAME)
public class ThreePointFieldGoal implements IPerformanceRecord, IAttempt {

	public static final String ENTITY_NAME = "tbl_basta_player_performance_3fg";
	...
	public String getDisplayString() {
		return "3 Point Field Goal " + (missed ? " Attempt" : "") + " by " + getPerformance().getPlayer().getDisplayString();
	}
