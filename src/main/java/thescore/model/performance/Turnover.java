...
@Entity(name = Turnover.ENTITY_NAME)
public class Turnover implements IPerformanceRecord {

	private static final long serialVersionUID = -1507796953018755543L;
	public static final String ENTITY_NAME = "tbl_basta_player_performance_to";
	...
	public String getDisplayString() {
		return "Turnover by " + getPerformance().getPlayer().getDisplayString();
	}
