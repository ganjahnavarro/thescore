...
@Entity(name = Block.ENTITY_NAME)
public class Block implements IPerformanceRecord {

	public static final String ENTITY_NAME = "tbl_basta_player_performance_blk";
	private static final long serialVersionUID = 6777937658538747392L;
	...
	public String getDisplayString() {
		return "Block by " + getPerformance().getPlayer().getDisplayString();
	}
